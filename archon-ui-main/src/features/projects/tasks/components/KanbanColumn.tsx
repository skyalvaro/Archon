...
import { ItemTypes, getColumnColor, getColumnGlow } from '../utils/task-styles';
  ...
  return (
    <div 
      ...
      className={cn(
        ...
        isOver && "shadow-[inset_0_2px_20px_rgba(34,211,238,0.15)] dark:shadow-[inset_0_2px_30px_rgba(34,211,238,0.25)]",
